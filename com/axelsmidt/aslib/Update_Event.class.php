...
/**
 * TODO: Implement checks to keep several users from changing the same
 * event simultaneously.
 */
class Update_Event extends Handler {
     ...
     * @Override
     */
    public function __construct($page_subtitle) {
        parent::__construct();
